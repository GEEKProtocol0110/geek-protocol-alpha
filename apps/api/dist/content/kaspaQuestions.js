...
export const KASPA_QUESTIONS = [
    // ── Kaspa Origins ──────────────────────────────────────────────────────────
    {
        ...
        correctIndex: 1,
        difficulty: "easy",
        funFact: "Sompolinsky's earlier research on the GHOST protocol was cited in Ethereum's own whitepaper.",
    ...
    },
    {
        ...
        correctIndex: 1,
        difficulty: "medium",
        funFact: "Every KAS in existence was mined — nobody, including the founders, was allocated coins at genesis.",
        tags: ["fair-launch", "distribution"],
    },
    {
        category: "Kaspa Origins",
        prompt: "Sompolinsky co-authored a 2013 paper whose ideas influenced Ethereum's handling of orphaned blocks. What was that protocol called?",
        options: ["GHOST", "CASPER", "RAIDEN", "PLASMA"],
        correctIndex: 0,
        difficulty: "hard",
        funFact: "GHOST — Greedy Heaviest Observed Sub-Tree — led to Ethereum's uncle/ommer rewards.",
        tags: ["research", "ghost"],
    },
    {
        category: "Kaspa Origins",
    ...
    {
        category: "Kaspa Origins",
        prompt: "The original Kaspa full node was written in one language, then rewritten for performance in another. Which rewrite is known as 'rusty-kaspa'?",
        options: ["Python to C++", "Go to Rust", "Java to Go", "C to Zig"],
        correctIndex: 1,
        difficulty: "medium",
        funFact: "The original node (kaspad) was written in Go; the Rust rewrite unlocked much higher block rates.",
        tags: ["engineering"],
    },
    {
        category: "Kaspa Origins",
        ...
        correctIndex: 0,
        difficulty: "hard",
        funFact: "DAGKnight is designed to be parameterless — it adapts to real network conditions instead of assuming a fixed delay.",
    ...
    {
        category: "GHOSTDAG & BlockDAG",
        prompt: "In a traditional blockchain, what happens when two miners find a valid block at the same time?",
        options: [
        ...
        correctIndex: 1,
        difficulty: "medium",
        funFact: "Discarding that work is exactly the waste GHOSTDAG was designed to eliminate.",
        tags: ["comparison"],
    },
    {
        category: "GHOSTDAG & BlockDAG",
        ...
        correctIndex: 1,
        difficulty: "medium",
        funFact: "No honest work is thrown away — this is the core idea that lets Kaspa raise block rates safely.",
        tags: ["ghostdag"],
    },
    {
        category: "GHOSTDAG & BlockDAG",
        ...
        correctIndex: 1,
        difficulty: "hard",
        funFact: "Poorly-connected blocks are coloured 'red' — still recorded, but treated as outside the honest set.",
    ...
    },
    {
        ...
        correctIndex: 1,
        difficulty: "medium",
        funFact: "A total order matters — without it you cannot reliably decide which of two conflicting spends came first.",
        tags: ["ordering"],
    },
    {
        category: "GHOSTDAG & BlockDAG",
    ...
    },
    {
        ...
        correctIndex: 2,
        difficulty: "medium",
        funFact: "kHeavyHash was designed with optical mining hardware in mind — a bet on a very different future for mining efficiency.",
    ...
    },
    {
        ...
        correctIndex: 0,
        difficulty: "medium",
        funFact: "One block per second was already extraordinary — Bitcoin targets one every ten minutes.",
        tags: ["block-rate"],
    },
    {
        category: "Mining & Consensus",
    ...
    },
    {
        ...
        correctIndex: 1,
        difficulty: "hard",
        funFact: "Each month the reward is multiplied by the twelfth root of one half, so a full halving takes a year without a sudden cliff.",
    ...
    },
    {
        ...
        correctIndex: 1,
        difficulty: "medium",
        funFact: "UTXO means your balance is the sum of unspent outputs you control, not a single stored number.",
        tags: ["utxo"],
    },
    {
        category: "Wallets & Addresses",
    ...
    {
        category: "Wallets & Addresses",
        prompt: "A Kaspa address contains a checksum. What does that protect against?",
        options: [
        ...
        correctIndex: 1,
        difficulty: "medium",
        funFact: "Change a single character and the checksum fails, so the wallet rejects it before any funds move.",
    ...
    },
    {
        ...
        correctIndex: 1,
        difficulty: "hard",
        funFact: "Because it's inscription-based, an indexer is what reconstructs token balances from the chain's history.",
    ...
    {
        category: "KRC-20 & Smart Contracts",
        prompt: "Why does adding a programmable layer increase the security burden on a network?",
        options: [
    ...
    },
    {
        ...
        correctIndex: 1,
        difficulty: "medium",
        funFact: "A small contributor base is a real consideration when you build on any chain — fewer maintainers means fewer ready-made tools.",
        tags: ["community"],
    },
    {
        category: "Kaspa Ecosystem",
